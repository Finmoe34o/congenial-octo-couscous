...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   GET: () => (/* binding */ GET)\n/* harmony export */ });\n/* harmony import */ var next_server__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! next/server */ \"(rsc)/./node_modules/next/dist/api/server.js\");\n/* harmony import */ var _lib_auth__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../lib/auth */ \"(rsc)/./app/lib/auth.ts\");\n/* harmony import */ var _lib_storage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../lib/storage */ \"(rsc)/./app/lib/storage.ts\");\n\n\n\nasync function GET(request) {\n    try {\n        // Get the current user\n        const user = await (0,_lib_auth__WEBPACK_IMPORTED_MODULE_1__.getCurrentUser)(request);\n        if (!user) {\n            return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n                error: \"Unauthorized\"\n            }, {\n                status: 401\n            });\n        }\n        // Check if the user is on a paid tier (Pro or Business)\n        if (user.subscriptionTier !== 'pro' && user.subscriptionTier !== 'business') {\n            return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n                error: \"This feature is only available on Pro or Business plans\"\n            }, {\n                status: 403\n            });\n        }\n        // Get the user's pricing suggestions\n        const suggestions = await _lib_storage__WEBPACK_IMPORTED_MODULE_2__.storage.getPriceSuggestions(user.id);\n        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json(suggestions);\n    } catch (error) {\n        console.error(\"Error fetching pricing suggestions:\", error);\n        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n            error: \"An unexpected error occurred\"\n        }, {\n            status: 500\n        });\n    }\n}\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(rsc)/./app/api/pricing-suggestions/route.ts\n");
